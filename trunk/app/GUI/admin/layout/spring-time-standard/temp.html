	...
	<div class="shell">
		...
		<div id="top">
			...
			<div id="top-navigation">
				Xin chào <a href="#"><strong>Võ Anh Kiệt</strong></a>
				<span>|</span>
				<a href="#">Liên hệ</a>
				<span>|</span>
				<a href="#">Tài khoản</a>
		...
		<div id="navigation">
			<ul>
			    <li><a href="<?php echo $this->baseUrl."?page=admin&action=index"; ?>" class="active"><span>Quản lý câu hỏi</span></a></li>
			    <li><a href="#"><span>Quản lý người dùng</span></a></li>
			</ul>
		</div>
		<!-- End Main Nav -->
	</div>
